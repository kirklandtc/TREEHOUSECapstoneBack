  ...
  return knex('reviews').del()
    .then(function () {
      ...
      return knex('reviews').insert([
        { id: 1, name: 'The Vanderbilt is Incredible!', body:'This is the best treehouse I have ever owned! Truly an amazing finished mini-house that our children love!', user_id:1, treehouse_id:1},
